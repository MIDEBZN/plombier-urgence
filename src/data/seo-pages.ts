...
export const serviceCityPages: ServiceCityPage[] = [
    ...
    },
    {
        ...
        metaDescription: 'Débouchage et curage de canalisation à Liège. WC bouché, douche baignoire ou évier. Intervention rapide par nos déboucheurs professionnels. ☎ 0465 68 51 58',
        keywords: ['débouchage canalisation Liège', 'curage canalisation Liège', 'WC bouché Liège', 'debouchage liège'],
        heroText: 'Vos canalisations sont bloquées ? Qu\'il s\'agisse d\'un WC bouché, d\'un évier engorgé, ou d\'une douche baignoire qui déborde, l\'eau stagnante peut vite devenir un cauchemar au quotidien. Souvent, ce sont l\'accumulation de déchets organiques ou un dysfonctionnement de fosse septique qui provoquent des mauvaises odeurs tenaces dans tout votre logement. Véritables spécialistes du debouchage liège, nos déboucheurs professionnels interviennent chez vous en moins de 45 minutes. Nous utilisons du matériel de pointe et la haute pression pour nettoyer vos installations en profondeur.',
        processSteps: [
            { title: 'Diagnostic Précis', desc: 'Une inspection caméra est réalisée pour identifier précisément la nature et la localisation exacte du bouchon.' },
            { title: 'Débouchage Haute Pression', desc: 'Utilisation d\'un camion hydrocureur puissant pour désintégrer les bouchons les plus tenaces.' },
            { title: 'Curage Préventif', desc: 'Nettoyage complet des parois de vos canalisations pour prévenir les récidives à l\'avenir.' },
            { title: 'Bilan et Rapport', desc: 'Compte-rendu d\'intervention détaillé avec recommandations pour l\'entretien quotidien de vos sanitaires.' },
        ],
        faqs: [
            { q: 'Quelle est la différence entre débouchage et curage de canalisation à Liège ?', a: 'Le débouchage élimine un bouchon précis (amas de cheveux, graisse...). Le curage, lui, est un nettoyage complet et préventif de l\'ensemble des canalisations. À Liège, nous combinons souvent les deux pour un résultat pérenne.' },
            { q: 'Mon WC est bouché à Liège, intervenez-vous rapidement ?', a: 'Oui, nous intervenons en 30 à 45 minutes dans tout le grand Liège pour un WC bouché, de jour comme de nuit. Appelez directement le 0465 68 51 58.' },
            { q: 'D\'où viennent ces mauvaises odeurs dans ma salle de bain ?', a: 'Elles peuvent provenir d\'un siphon désamorcé, d\'une accumulation de déchets invisibles, ou d\'un problème lié à la fosse septique. Notre inspection caméra permet de poser un diagnostic 100% fiable.' },
        ],
    },
    {
        ...
        metaDescription: 'Besoin d\'un débouchage canalisation charleroi ? Notre société intervient pour toute toilette bouchée, remontée d\'eaux usées. Débouchage rapide 24h/24. ☎ 0465 68 51 58',
        keywords: ['canalisation bouchée Charleroi', 'remontée d\'eau Charleroi', 'débouchage canalisation charleroi'],
        heroText: 'Face à une canalisation bouchée ou des odeurs désagréables à Charleroi ? Ne laissez pas une toilette bouchée ou des douches baignoires engorgées gâcher votre confort. Notre société de débouchage met à votre disposition des déboucheurs professionnels hautement qualifiés. En tant que spécialistes du débouchage à charleroi, nous garantissons un service rapide pour bloquer toute remontée d\'eaux usées et assainir durablement vos installations.',
        processSteps: [
            { title: 'Évaluation urgente', desc: 'Diagnostic immédiat avec inspection caméra pour cibler la cause du bouchon.' },
            { title: 'Pompage', desc: 'Évacuation et pompage des eaux usées stagnantes si la situation l\'exige.' },
            { title: 'Débouchage Haute Pression', desc: 'Élimination du bouchon par hydrocurage.' },
            { title: 'Prévention', desc: 'Installation de clapets anti-retour pour empêcher les futurs dégâts.' },
        ],
        faqs: [
            { q: 'Que faire en cas de mauvaises odeurs persistantes à Charleroi ?', a: 'Les mauvaises odeurs proviennent souvent d\'un bouchon naissant. Consultez notre site pour des informations utiles ou contactez-nous pour une inspection caméra complète. Nous offrons un excellent rapport qualité prix dans la région.' },
            { q: 'Combien coûte le débouchage d\'une canalisation à Charleroi ?', a: 'Un service rapide pour un débouchage simple démarre à 60€. Les tarifs varient selon l\'intervention, mais nous pratiquons des prix transparents. Devis gratuit et sans engagement.' },
        ],
    },
    {
